            ...
            <div className="container max-w-4xl mx-auto text-center z-10">
                <div className="space-y-6">
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto opacity-0 animate-fade-in-delay-3">
                        ...
                        Digital Design, and robotics. I've worked on a wide range of innovative projects, from
                        building electronic circuits to developing systems on FPGAs. I enjoy learning new
                        technologies and applying them to create practical solutions to real-world problems.
                    </p>
